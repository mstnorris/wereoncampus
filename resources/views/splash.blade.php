...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>We're On Campus</title>
		<meta name="description" content="We're On Campus">
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="site-name-and-slogan smooth-scroll">
								<div class="site-name"><a href="#banner">We're On Campus</a></div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
							<h1 class="text-center">We're On Campus</h1>
							<p class="lead text-center">Developing state of the art solutions for educational establishments all over the world.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<footer id="footer">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="footer-content">
								...
								<ul class="list-icons">
									<li><i class="fa fa-map-marker"></i> 78A Sackville Road, Hove, UK</li>
									<li><i class="fa fa-phone"></i> +44 (0) 1273 276 739</li>
									<li><i class="fa fa-mobile pr-10"></i> +44 (0) 7446 990 061</li>
									<li><i class="fa fa-envelope-o pr-10"></i> {{ "hello@wereoncamp.us" }}</li>
								</ul>
			...
			<div class="subfooter">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p class="text-center">Copyright &copy; {{ date('Y') }} We're On Campus by <a target="_blank" href="http://michaelnorris.co.uk">Michael Norris</a> & <a target="_blank" href="http://sezertunca.com">Sezer Tunca</a> </p>
						</div>
					</div>
				</div>
			</div>
